...
const typeArray = [
  ...
  },
  {
    type: 'folder',
    icon:
      'https://res.cloudinary.com/drolmjcot/image/upload/q_auto:good/v1614057434/folder-icon_uv8y4m.png',
  },
  {
    type: '.webapp',
    icon:
      'https://res.cloudinary.com/drolmjcot/image/upload/v1615476171/web-app-icon-7_pkp4ya.png',
  },
  {
    type: 'other',
    icon:
      'https://res.cloudinary.com/drolmjcot/image/upload/v1615477432/add-file_whluwf.png',
  },
];

export { handleIcon, typeArray };
